#!/usr/bin/env node
// evolve-kontext-lora.mjs — Single-pass evolution using FLUX Kontext + LoRA
// Best of both worlds: Kontext identity preservation + Palette Knife LoRA style.
...
async function main() {
  console.log('\n=== FLUX Kontext + LoRA Evolution Test ===\n');
  ...
  for (const card of TEST_CARDS) {
    ...
    try {
      ...
      const outFile = card.baseFile.replace('.png', '-kl.png');
