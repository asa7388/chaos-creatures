...
const EVOLUTIONS = [
  {
    ...
    faction_style: 'brutalist space-industrial construct, poured concrete and rusted iron with exposed rebar, in the style of Piranesi Carceri and John Martin',
