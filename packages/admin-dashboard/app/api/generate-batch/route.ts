...
export async function POST(request: NextRequest) {
  try {
    ...
    const { faction_id, count, card_type, creature_type_hint, creature_descriptions, creature_subtype, composition_modifiers } = body;
    ...
    for (let i = 0; i < effectiveCount; i++) {
      ...
      jobs.push({
        ...
        input_data: {
          ...
          creature_subtype: creature_subtype || undefined,
